# Hirely LinkedIn extension 1.3.0
The extension reads the visible LinkedIn profile, lets the recruiter review the fields, and saves the contact to Supabase under their account.
