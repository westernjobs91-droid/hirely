...
export default function TermsPage() {
  return (
    <PublicInfoLayout title="Terms of Service" updated="September 22, 2026">
      ...
      <section><h2>Plans and usage</h2><p>Plans may include monthly limits for email searches, verification, AI, transcription, or other paid features. An email-finder credit is charged only when an email address is returned. Current pricing and included limits are shown before purchase. Subscription cancellation applies to future renewals unless stated otherwise at checkout.</p></section>
