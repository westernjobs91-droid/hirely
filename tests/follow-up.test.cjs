...
const moduleValue={exports:{}};vm.runInNewContext(ts.transpileModule(fs.readFileSync('lib/follow-up.ts','utf8'),{compilerOptions:{module:ts.ModuleKind.CommonJS,target:ts.ScriptTarget.ES2022}}).outputText,{module:moduleValue,exports:moduleValue.exports,Date});const {normalizeFollowUp:n,addDays,validDay,matchesPipelineFilter:f,localDay}=moduleValue.exports;
